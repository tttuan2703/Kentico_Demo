...
[assembly: RegisterDocumentType(Excavator.CLASS_NAME, typeof(Excavator))]

namespace CMS.DocumentEngine.Types.DancingGoatCore
{
	/// <summary>
	/// Represents a content item of type Excavator.
	/// </summary>
	public partial class Excavator : SKUTreeNode
	{
		...
		/// </summary>
		public const string CLASS_NAME = "DancingGoatCore.Excavator";


		/// <summary>
		/// The instance of the class that provides extended API for working with Excavator fields.
		/// </summary>
		private readonly ExcavatorFields mFields;
		...
		public int ExcavatorID
		{
			get
			{
				return ValidationHelper.GetInteger(GetValue("ExcavatorID"), 0);
			}
			set
			{
				SetValue("ExcavatorID", value);
			}
		}
		...
		/// </summary>
		[DatabaseField]
		public string ExcavatorVariety
		{
			get
			{
				return ValidationHelper.GetString(GetValue("ExcavatorVariety"), @"");
			}
			set
			{
				SetValue("ExcavatorVariety", value);
			}
		}


		/// <summary>
		/// Excavator Processing.
		/// </summary>
		[DatabaseField]
		public string ExcavatorProcessing
		{
			get
			{
				return ValidationHelper.GetString(GetValue("ExcavatorProcessing"), @"");
			}
			set
			{
				SetValue("ExcavatorProcessing", value);
			}
		}
		...
		/// </summary>
		[DatabaseField]
		public int ExcavatorAltitude
		{
			get
			{
				return ValidationHelper.GetInteger(GetValue("ExcavatorAltitude"), 0);
			}
			set
			{
				SetValue("ExcavatorAltitude", value);
			}
		}
		...
		/// </summary>
		[DatabaseField]
		public bool ExcavatorIsDecaf
		{
			get
			{
				return ValidationHelper.GetBoolean(GetValue("ExcavatorIsDecaf"), false);
			}
			set
			{
				SetValue("ExcavatorIsDecaf", value);
			}
		}
		...
		/// <summary>
		/// Gets an object that provides extended API for working with Excavator fields.
		/// </summary>
		[RegisterProperty]
		public ExcavatorFields Fields
		{
			get
			{
				return mFields;
		...
		/// <summary>
		/// Provides extended API for working with Excavator fields.
		/// </summary>
		[RegisterAllProperties]
		public partial class ExcavatorFields : AbstractHierarchicalObject<ExcavatorFields>
		{
			/// <summary>
			/// The content item of type Excavator that is a target of the extended API.
			/// </summary>
			private readonly Excavator mInstance;


			/// <summary>
			/// Initializes a new instance of the <see cref="ExcavatorFields" /> class with the specified content item of type Excavator.
			/// </summary>
			/// <param name="instance">The content item of type Excavator that is a target of the extended API.</param>
			public ExcavatorFields(Excavator instance)
			{
				mInstance = instance;
			}
			...
			public int ID
			{
				get
				{
					return mInstance.ExcavatorID;
				}
				set
				{
					mInstance.ExcavatorID = value;
				}
			}
			...
			public string Variety
			{
				get
				{
					return mInstance.ExcavatorVariety;
				}
				set
				{
					mInstance.ExcavatorVariety = value;
				}
			}
			...
			public string Processing
			{
				get
				{
					return mInstance.ExcavatorProcessing;
				}
				set
				{
					mInstance.ExcavatorProcessing = value;
				}
			}
			...
			public int Altitude
			{
				get
				{
					return mInstance.ExcavatorAltitude;
				}
				set
				{
					mInstance.ExcavatorAltitude = value;
				}
			}
			...
			public bool IsDecaf
			{
				get
				{
					return mInstance.ExcavatorIsDecaf;
				}
				set
				{
					mInstance.ExcavatorIsDecaf = value;
				}
			}
		...
		{
		    /// <summary>
			/// The content item of type <see cref="Excavator" /> that is a target of the extended API.
			/// </summary>
			private readonly Excavator mInstance;
			...
			/// <summary>
			/// Initializes a new instance of the <see cref="ProductFields" /> class with SKU related fields of type <see cref="Excavator" /> .
			/// </summary>
			/// <param name="instance">The content item of type Excavator that is a target of the extended API.</param>
			public ProductFields(Excavator instance)
			{
				mInstance = instance;
			}
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="Excavator" /> class.
		/// </summary>
		public Excavator() : base(CLASS_NAME)
		{
			mFields = new ExcavatorFields(this);
