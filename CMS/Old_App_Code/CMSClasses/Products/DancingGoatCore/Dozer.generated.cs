...
[assembly: RegisterDocumentType(Dozer.CLASS_NAME, typeof(Dozer))]

namespace CMS.DocumentEngine.Types.DancingGoatCore
{
	/// <summary>
	/// Represents a content item of type Dozer.
	/// </summary>
	public partial class Dozer : SKUTreeNode
	{
		...
		/// </summary>
		public const string CLASS_NAME = "DancingGoatCore.Dozer";


		/// <summary>
		/// The instance of the class that provides extended API for working with Dozer fields.
		/// </summary>
		private readonly DozerFields mFields;
		...
		public int DozerID
		{
			get
			{
				return ValidationHelper.GetInteger(GetValue("DozerID"), 0);
			}
			set
			{
				SetValue("DozerID", value);
			}
		}
		...
		/// </summary>
		[DatabaseField]
		public string DozerVariety
		{
			get
			{
				return ValidationHelper.GetString(GetValue("DozerVariety"), @"");
			}
			set
			{
				SetValue("DozerVariety", value);
			}
		}
		...
		/// </summary>
		[DatabaseField]
		public string DozerProcessing
		{
			get
			{
				return ValidationHelper.GetString(GetValue("DozerProcessing"), @"");
			}
			set
			{
				SetValue("DozerProcessing", value);
			}
		}
		...
		/// </summary>
		[DatabaseField]
		public int DozerAltitude
		{
			get
			{
				return ValidationHelper.GetInteger(GetValue("DozerAltitude"), 0);
			}
			set
			{
				SetValue("DozerAltitude", value);
			}
		}
		...
		/// </summary>
		[DatabaseField]
		public bool DozerIsDecaf
		{
			get
			{
				return ValidationHelper.GetBoolean(GetValue("DozerIsDecaf"), false);
			}
			set
			{
				SetValue("DozerIsDecaf", value);
			}
		}
		...
		/// <summary>
		/// Gets an object that provides extended API for working with Dozer fields.
		/// </summary>
		[RegisterProperty]
		public DozerFields Fields
		{
			get
			{
				return mFields;
		...
		/// <summary>
		/// Provides extended API for working with Dozer fields.
		/// </summary>
		[RegisterAllProperties]
		public partial class DozerFields : AbstractHierarchicalObject<DozerFields>
		{
			/// <summary>
			/// The content item of type Dozer that is a target of the extended API.
			/// </summary>
			private readonly Dozer mInstance;


			/// <summary>
			/// Initializes a new instance of the <see cref="DozerFields" /> class with the specified content item of type Dozer.
			/// </summary>
			/// <param name="instance">The content item of type Dozer that is a target of the extended API.</param>
			public DozerFields(Dozer instance)
			{
				mInstance = instance;
			}
			...
			public int ID
			{
				get
				{
					return mInstance.DozerID;
				}
				set
				{
					mInstance.DozerID = value;
				}
			}
			...
			public string Variety
			{
				get
				{
					return mInstance.DozerVariety;
				}
				set
				{
					mInstance.DozerVariety = value;
				}
			}
			...
			public string Processing
			{
				get
				{
					return mInstance.DozerProcessing;
				}
				set
				{
					mInstance.DozerProcessing = value;
				}
			}
			...
			public int Altitude
			{
				get
				{
					return mInstance.DozerAltitude;
				}
				set
				{
					mInstance.DozerAltitude = value;
				}
			}
			...
			public bool IsDecaf
			{
				get
				{
					return mInstance.DozerIsDecaf;
				}
				set
				{
					mInstance.DozerIsDecaf = value;
				}
			}
		...
		{
		    /// <summary>
			/// The content item of type <see cref="Dozer" /> that is a target of the extended API.
			/// </summary>
			private readonly Dozer mInstance;
			...
			/// <summary>
			/// Initializes a new instance of the <see cref="ProductFields" /> class with SKU related fields of type <see cref="Dozer" /> .
			/// </summary>
			/// <param name="instance">The content item of type Dozer that is a target of the extended API.</param>
			public ProductFields(Dozer instance)
			{
				mInstance = instance;
			}
		...
		/// </summary>
		public Dozer() : base(CLASS_NAME)
		{
			mFields = new DozerFields(this);
