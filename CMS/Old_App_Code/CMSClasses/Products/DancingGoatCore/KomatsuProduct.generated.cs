...
[assembly: RegisterDocumentType(KomatsuProduct.CLASS_NAME, typeof(KomatsuProduct))]

namespace CMS.DocumentEngine.Types.DancingGoatCore
{
	/// <summary>
	/// Represents a content item of type KomatsuProduct.
	/// </summary>
	public partial class KomatsuProduct : SKUTreeNode
	{
		...
		/// </summary>
		public const string CLASS_NAME = "DancingGoatCore.KomatsuProduct";


		/// <summary>
		/// The instance of the class that provides extended API for working with KomatsuProduct fields.
		/// </summary>
		private readonly KomatsuProductFields mFields;
		...
		/// </summary>
		[DatabaseIDField]
		public int KomatsuProductID
		{
			get
			{
				return ValidationHelper.GetInteger(GetValue("KomatsuProductID"), 0);
			}
			set
			{
				SetValue("KomatsuProductID", value);
			}
		}
		...
		public string OperatingWeight
		{
			get
			{
				return ValidationHelper.GetString(GetValue("OperatingWeight"), @"USA");
			}
			set
			{
		...
		/// <summary>
		/// Gets an object that provides extended API for working with KomatsuProduct fields.
		/// </summary>
		[RegisterProperty]
		public KomatsuProductFields Fields
		{
			get
			{
				return mFields;
		...
		/// <summary>
		/// Provides extended API for working with KomatsuProduct fields.
		/// </summary>
		[RegisterAllProperties]
		public partial class KomatsuProductFields : AbstractHierarchicalObject<KomatsuProductFields>
		{
			/// <summary>
			/// The content item of type KomatsuProduct that is a target of the extended API.
			/// </summary>
			private readonly KomatsuProduct mInstance;


			/// <summary>
			/// Initializes a new instance of the <see cref="KomatsuProductFields" /> class with the specified content item of type KomatsuProduct.
			/// </summary>
			/// <param name="instance">The content item of type KomatsuProduct that is a target of the extended API.</param>
			public KomatsuProductFields(KomatsuProduct instance)
			{
				mInstance = instance;
			}
			...
			public int ID
			{
				get
				{
					return mInstance.KomatsuProductID;
				}
				set
				{
					mInstance.KomatsuProductID = value;
				}
			}
		...
		{
		    /// <summary>
			/// The content item of type <see cref="KomatsuProduct" /> that is a target of the extended API.
			/// </summary>
			private readonly KomatsuProduct mInstance;
			...
			/// <summary>
			/// Initializes a new instance of the <see cref="ProductFields" /> class with SKU related fields of type <see cref="KomatsuProduct" /> .
			/// </summary>
			/// <param name="instance">The content item of type KomatsuProduct that is a target of the extended API.</param>
			public ProductFields(KomatsuProduct instance)
			{
				mInstance = instance;
			}
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="KomatsuProduct" /> class.
		/// </summary>
		public KomatsuProduct() : base(CLASS_NAME)
		{
			mFields = new KomatsuProductFields(this);
